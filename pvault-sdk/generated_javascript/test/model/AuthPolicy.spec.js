...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiianoVaultRestApi.AuthPolicy();
  });
  ...
  describe('AuthPolicy', function() {
    it('should create an instance of AuthPolicy', function() {
      // uncomment below and update the code to test AuthPolicy
      //var instance = new PiianoVaultRestApi.AuthPolicy();
      //expect(instance).to.be.a(PiianoVaultRestApi.AuthPolicy);
    });
